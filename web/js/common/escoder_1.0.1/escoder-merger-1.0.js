...
ESCoder.Merger = function(cfg){
	 ...
	 if(cfg){
		 ...
		 if(cfg.submitHandler){
			 this.submitHandler = cfg.submitHandler;
		 }
		 if(cfg.submitBt){
			 this.submitBt = cfg.submitBt;
		 }
		 if(cfg.backBt){
 ...
 ESCoder.Merger.prototype = {
	 ...
	 setSubmitBt : function(submitBt){
		 this.submitBt = submitBt;
	 },
	 getSubmitBt : function(){
	 ...
	 toSubmitHandler : function(evt,selfManager){
		 evt.preventDefault();
		 $('#' + selfManager.getInputForm()).submit();
	 },
	 ...
	 start : function(callback){
		...
		var _submitHandler = $.isFunction(this.submitHandler) ? this.submitHandler : this.toSubmitHandler;
        var backIndexHandler = this.backIndexHandler;
        
		$('#' + this.getSubmitBt()).click(function(evt){
			_submitHandler(evt,selfManager);
		});
