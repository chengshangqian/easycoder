package org.ican.easycode.generator.durian;
...
public class DurianGenerator extends AbstractDurianGenerator{
	
	public DurianGenerator(){
		super();
	}
	
	public DurianGenerator(Configuration configuration){
		super(configuration);
	}
	
	public DurianGenerator(MDMetaData metaDatas){
		super(metaDatas);
	}
	
	public DurianGenerator(MDMetaData metaDatas,Configuration configuration){
	...
	public static void main(String[] args) throws Exception {
		...
		Generator generator = new DurianGenerator(metaDatas,configuration);
		generator.run();
	}
