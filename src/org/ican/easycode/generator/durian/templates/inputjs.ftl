 ...
 */
  ...
  $(function(){
	 ...
	 xhEditors.push('${MROUtil.tableNameToBeanName(column.columnName)}');
	 </#if>
	 </#if>
	 </#list>
	 ...
	 rules['formMap.${MROUtil.tableNameToBeanName(column.columnName)}'] = {required:true};
	 </#if>		 
	 <#break>
	 <#case "email">
	 <#case "url">
	 ...
	 <#break>
	 <#default>
	 rules['formMap.${MROUtil.tableNameToBeanName(column.columnName)}'] = {required:true,${column.columnDef}:true};
	 </#switch>
	 <#else>
	 rules['formMap.${MROUtil.tableNameToBeanName(column.columnName)}'] = {${column.columnDef}:true};
	 </#if>
	 <#break>
	 <#default>
	 <#if (column.isRequired())>
	 rules['formMap.${MROUtil.tableNameToBeanName(column.columnName)}'] = {required:true,${column.columnDef}:${column.format}};
	 <#else>
	 rules['formMap.${MROUtil.tableNameToBeanName(column.columnName)}'] = {${column.columnDef}:${column.format}};
	 </#if>		 
	 </#switch>
	 </#if>
	 </#list>
