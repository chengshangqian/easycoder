...
public abstract class AbstractDurianGenerator extends AbstractGenerator {
	...
	public AbstractDurianGenerator(){
		super();
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractDurianGenerator(MDMetaData metaDatas){
		super(metaDatas);
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractDurianGenerator(Configuration configuration){
		this();
		this.configuration = configuration;
	}
	
	public AbstractDurianGenerator(MDMetaData metaDatas,Configuration configuration){
		this(metaDatas);
		this.configuration = configuration;
	}
