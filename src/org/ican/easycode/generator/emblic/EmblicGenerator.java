package org.ican.easycode.generator.emblic;
...
public class EmblicGenerator extends AbstractEmblicGenerator{
	
	public EmblicGenerator(){
		super();
	}
	
	public EmblicGenerator(Configuration configuration){
		super(configuration);
	}
	
	public EmblicGenerator(MDMetaData metaDatas){
		super(metaDatas);
	}
	
	public EmblicGenerator(MDMetaData metaDatas,Configuration configuration){
	...
	public static void main(String[] args) throws Exception {
		...
		Generator generator = new EmblicGenerator(metaDatas,configuration);
		generator.run();
	}
