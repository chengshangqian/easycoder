...
<!-- 
<gzdec:rightsButton rightCode="${metadata.tables[0].tableName}_ADD" value="新增" cssClass="input_btn_style2" elementId="createBt"></gzdec:rightsButton>&nbsp;&nbsp;<gzdec:rightsButton rightCode="${metadata.tables[0].tableName}_DEL_SELECTED" value="删除所选" cssClass="input_btn_style1" elementId="deleteSelected"></gzdec:rightsButton>
-->
<input id="createBt" type="button" value="新增"  class="input_btn_style2" />&nbsp;&nbsp;<input id="deleteSelected" type="button" value="删除所选"  class="input_btn_style1" /></span>
</div>
<div class="table_bg">
<table align="center">
<tr>
...
<#list metadata.tables[0].columns as column>
<#if (column.isHead())>
<td align="center"><s:property value="${column.columnName}"/></td>
</#if>
</#list>
<td align="center">
<%-- 
...
<gzdec:rightsHref href="/${metadata.projectName}/${metadata.moduleName}/${MROUtil.tableNameToBeanName(metadata.tables[0].tableName)}/doInput.do?formMap.${metadata.tables[0].primaryKey}=<s:property value="${metadata.tables[0].primaryKey}"/>" rightCode="${metadata.tables[0].tableName}_EDIT" text="修改" cssClass="edit" />
<gzdec:rightsHref href="/${metadata.projectName}/${metadata.moduleName}/${MROUtil.tableNameToBeanName(metadata.tables[0].tableName)}/remove.do?formMap.delete${MROUtil.upperFirstChar(MROUtil.tableNameToBeanName(metadata.tables[0].primaryKey))}=<s:property value="${metadata.tables[0].primaryKey}"/>" rightCode="${metadata.tables[0].tableName}_DEL" text="删除" cssClass="delete" />
--%>
<a href="/${metadata.projectName}/${metadata.moduleName}/${MROUtil.tableNameToBeanName(metadata.tables[0].tableName)}/doInput.do?formMap.${metadata.tables[0].primaryKey}=<s:property value="${metadata.tables[0].primaryKey}"/>" class="edit">修改</a>
<a href="/${metadata.projectName}/${metadata.moduleName}/${MROUtil.tableNameToBeanName(metadata.tables[0].tableName)}/remove.do?formMap.delete${MROUtil.upperFirstChar(MROUtil.tableNameToBeanName(metadata.tables[0].primaryKey))}=<s:property value="${metadata.tables[0].primaryKey}"/>" class="delete">删除</a>
</td>
</tr>
</s:iterator>
