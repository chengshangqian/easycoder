...
public abstract class AbstractGrapeGenerator extends AbstractGenerator {
	...
	public AbstractGrapeGenerator(){
		super();
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractGrapeGenerator(MDMetaData metaDatas){
		super(metaDatas);
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractGrapeGenerator(Configuration configuration){
		this();
		this.configuration = configuration;
	}
	
	public AbstractGrapeGenerator(MDMetaData metaDatas,Configuration configuration){
		this(metaDatas);
		this.configuration = configuration;
	}
