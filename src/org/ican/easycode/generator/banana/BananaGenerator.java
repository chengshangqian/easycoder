...
public class BananaGenerator extends AbstractBananaGenerator{
	
	public BananaGenerator(){
		super();
	}
	
	public BananaGenerator(Configuration configuration){
		super(configuration);
	}
	
	public BananaGenerator(MDMetaData metaDatas){
		super(metaDatas);
	}
	
	public BananaGenerator(MDMetaData metaDatas,Configuration configuration){
	...
	public static void main(String[] args) throws Exception {
		...
		Generator generator = new BananaGenerator(metaDatas,configuration);
		generator.run();
	}
