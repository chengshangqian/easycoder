...
public abstract class AbstractBananaGenerator extends AbstractGenerator {
	...
	public AbstractBananaGenerator(){
		super();
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractBananaGenerator(MDMetaData metaDatas){
		super(metaDatas);
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractBananaGenerator(Configuration configuration){
		this();
		this.configuration = configuration;
	}
	
	public AbstractBananaGenerator(MDMetaData metaDatas,Configuration configuration){
		this(metaDatas);
		this.configuration = configuration;
	}
