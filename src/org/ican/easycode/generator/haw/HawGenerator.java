...
public class HawGenerator extends AbstractHawGenerator{
	
	public HawGenerator(){
		super();
	}
	
	public HawGenerator(Configuration configuration){
		super(configuration);
	}
	
	public HawGenerator(MDMetaData metaDatas){
		super(metaDatas);
	}
	
	public HawGenerator(MDMetaData metaDatas,Configuration configuration){
	...
	public static void main(String[] args) throws Exception {
		...
		Generator generator = new HawGenerator(metaDatas,configuration);
		generator.run();
	}
