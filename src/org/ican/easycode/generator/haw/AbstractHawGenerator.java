package org.ican.easycode.generator.haw;
...
public abstract class AbstractHawGenerator extends AbstractGenerator {
	...
	public AbstractHawGenerator(){
		super();
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractHawGenerator(MDMetaData metaDatas){
		super(metaDatas);
		wrapper = BeansWrapper.getDefaultInstance();
		staticModels = wrapper.getStaticModels();
	}
	
	public AbstractHawGenerator(Configuration configuration){
		this();
		this.configuration = configuration;
	}
	
	public AbstractHawGenerator(MDMetaData metaDatas,Configuration configuration){
		this(metaDatas);
		this.configuration = configuration;
	}
